    ...
    child: Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // En-tête avec infos utilisateur et table
            Row(
              children: [
                const CircleAvatar(
    ...
    builder: (BuildContext context) {
      return Container(
        ...
        child: Column(
          ...
          children: [
            // En-tête avec info utilisateur et table
            Row(
              children: [
                const CircleAvatar(
                  backgroundColor: AppTheme.accentColor, // Utiliser la couleur d'accent du thème
                  radius: 20,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: statusColor, // Utiliser la couleur de statut dynamique
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Text(
                    statusText, // Utiliser le texte de statut dynamique
                    style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 12,
            ...
            if (!isServed && !isCancelled) ...[
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.red, // Couleur rouge pour l'annulation
              ...
              if (isReady)
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppTheme.secondaryColor, // Utiliser la couleur secondaire du thème
                    padding: const EdgeInsets.symmetric(vertical: 12),
                  ),
                  child: const Text(
                    'Servir',

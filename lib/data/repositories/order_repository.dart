  ...
  Future<List<Order>> getNewOrders() async {
    ...
    return [
      Order(
        ...
        items: [
          OrderItem(id: 'item11', name: 'Café', quantity: 4, price: 2.5),
        ],
      ),
      Order(
        id: 'order3',
        ...
        items: [
          OrderItem(id: 'item4', name: 'Pizza', quantity: 2, price: 15.0),
          OrderItem(id: 'item5', name: 'Salade', quantity: 1, price: 8.0),
        ],
      ),
    ];
  }
  ...
  Future<List<Order>> getReadyOrders() async {
    ...
    return [
      Order(
        ...
        items: [
          OrderItem(id: 'item1', name: 'Burger', quantity: 2, price: 12.5),
          OrderItem(id: 'item2', name: 'Frites', quantity: 1, price: 4.0),
        ],
      ),
      Order(
        id: 'order4',
        ...
        items: [
          OrderItem(id: 'item6', name: 'Dessert', quantity: 5, price: 6.0),
        ],
      ),
      Order(
        id: 'order7',
        ...
        items: [
          OrderItem(id: 'item10', name: 'Pâtes', quantity: 4, price: 14.0),
        ],
      ),
    ];
  }
  ...
  Future<List<Order>> getServedOrders() async {
    ...
    return [
      Order(
        ...
        items: [
          OrderItem(id: 'item7', name: 'Apéritif', quantity: 5, price: 5.0),
        ],
      ),
    ];
  }
  ...
  Future<List<Order>> getCancelledOrders() async {
    ...
    return [
      Order(
        ...
        createdAt: DateTime.now().subtract(const Duration(minutes: 30)),
        items: [
          OrderItem(id: 'item12', name: 'Sushi', quantity: 1, price: 18.0),
        ],
      ),
    ];
  }
  ...
  Future<List<Order>> getPreparingOrders() async {
    ...
    return [
      Order(
        ...
        createdAt: DateTime.now().subtract(const Duration(minutes: 15)),
        items: [
          OrderItem(id: 'item3', name: 'Boisson', quantity: 3, price: 3.5),
        ],
      ),
      Order(
        id: 'order6',
        ...
        createdAt: DateTime.now().subtract(const Duration(minutes: 10)),
        items: [
          OrderItem(id: 'item8', name: 'Steak', quantity: 6, price: 22.0),
          OrderItem(id: 'item9', name: 'Vin', quantity: 2, price: 28.0),
        ],
      ),
    ];
  }
